                    ...
                    <div class="col-sm-12">
                      <div class="manage-button">
                        ...
                        <div class="quick-button">
                          <a href="{{url('admin/employee/add')}}" class="btn btn-primary btn-actions btn-create">
                          ...
                          <td>
                            <ul class="action_buttons">
                                <li>
                                  ...
                                  <li>
                                      <a class="edit_icon" href="{{url('admin/employee/edit/'.$value->id)}}" title="Edit"><i class="fa fa-edit"></i></a>
                                  </li>
                                  <li>
