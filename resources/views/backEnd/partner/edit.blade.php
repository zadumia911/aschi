          ...
          <div class="col-sm-12">
            <div class="manage-button">
              ...
              <div class="quick-button">
                <a href="{{url('editor/partner/manage')}}" class="btn btn-primary btn-actions btn-create">
                Manage
                </a>
            ...
            <div class="row">
              ...
              <div class="col-lg-8 col-md-8 col-sm-8">
                  <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{url('editor/partner/update')}}" method="POST" enctype="multipart/form-data" name="editForm">
                      @csrf
