          ...
          <div class="col-sm-12">
            <div class="manage-button">
              ...
              <div class="quick-button">
                <a href="{{url('editor/gallery/manage')}}" class="btn btn-primary btn-actions btn-create">
                Manage
                </a>
              </div>
            </div>
              ...
              <div class="col-lg-8 col-md-8 col-sm-8">
                  <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Add a new Gallery</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{url('editor/gallery/store')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="card-body">
