              ...
              <div class="col-lg-8 col-md-8 col-sm-8">
                  <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Add Career Info</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{url('editor/career/store')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          <label for="exprience">Exprience</label>
                              <input type="text" class="form-control {{ $errors->has('exprience') ? ' is-invalid' : '' }}" value="{{ old('exprience') }}" name="exprience" id="exprience">
