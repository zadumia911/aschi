            ...
            <div class="row">
              ...
              <div class="col-lg-8 col-md-8 col-sm-8">
                  <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{url('editor/blog/store')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="card-body">
                        ...
                        <label for="text_en">Description</label>
                          <textarea type="text" class="summernote form-control {{ $errors->has('text_en') ? ' is-invalid' : '' }}" value="{{ old('text_en') }}" name="text_en"></textarea>
