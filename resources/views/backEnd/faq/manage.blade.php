          ...
          <div class="col-sm-12">
            <div class="manage-button">
              <div class="body-title">
                <h5>Manage Faq Info</h5>
              </div>
              <div class="quick-button">
                <a href="{{url('editor/faq/create')}}" class="btn btn-primary btn-actions btn-create">
                Create
                </a>
              </div>
            </div>
                          ...
                          <td><ul class="action_buttons dropdown">
                              ...
                              <ul class="dropdown-menu">
                                <li>
                                  ...
                                  <li>
                                      <a class="edit_icon" href="{{url('editor/faq/edit/'.$value->id)}}" title="Edit"><i class="fa fa-edit"></i> Edit</a>
                                  </li>
                                  <li>
                                    <form action="{{url('editor/faq/delete')}}" method="POST">
                                      @csrf
                                      <input type="hidden" name="hidden_id" value="{{$value->id}}">
